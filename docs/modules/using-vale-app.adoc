...
* Optional: To use AI-powered issue fixing, install and run https://ollama.ai/[Ollama] on your host machine with at least one model (for example, `ollama pull llama2`).
